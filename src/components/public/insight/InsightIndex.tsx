...
/**
 * The journal list, shared by /insight and each /insight/<category> landing
 * page. It used to be a client island that filtered in place; every category
 * now has a URL of its own, so the tabs are links and the filtering happens on
 * the server — same markup, no client JS, and each category is crawlable.
 *
 * The newest story of whatever list is rendered is promoted to the lead
