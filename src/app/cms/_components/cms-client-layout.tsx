...
import {
  ...
  Users, Settings, LogOut, Menu, X, ChevronRight, KeyRound, HelpCircle, Home, Languages, Newspaper, Video
} from 'lucide-react';
...
const sidebarItems: SidebarItem[] = [
  ...
  { href: '/cms/videos', icon: Video, labelKey: 'sidebar.videos', group: 'catalog' },
