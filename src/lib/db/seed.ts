...
async function seed() {
  ...
  const aboutContent = `<p>Established in 2005, Jiaxing Chengtai Mirror Co., Ltd. is a premier manufacturer specializing in high-end mirror solutions, including LED, bathroom, and full-body mirrors. Our state-of-the-art, self-owned facility spans 48,000 square meters in Jiaxing, Zhejiang — strategically located just 60km from Shanghai Port for efficient global logistics.</p>
